		...
		case VT_boolean:
			{
				bool bData;
				vp >> bData;
				return SetGlobalVariables(sPropName, JS_GLOBALDATA_TYPE_BOOLEAN, 0, (bool)vp, "", v8::Local<v8::Object>(), FALSE);
			}
		case VT_string:
			{
...
{
	v8::Local<v8::Array> pKeyList = JS_GetObjectElementNames(pObj);
